    ...
    <div className="about-section" id="about">
      ...
      <div className="about-text-content">
        ...
        <p className="about-description">
          {
            "Welcome to AyurBot, your gateway to the harmonious fusion of ancient Ayurvedic wisdom and modern technology. At AyurBot, we're dedicated to empowering individuals with profound insights into their well-being, health, and constitution. Our journey began with a simple yet powerful question: how can we blend the timeless principles of Ayurveda with the precision of modern machine learning to enhance lives?"
          }
        </p>
